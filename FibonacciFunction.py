...
if __name__ == "__main__":
    ...
    print("fib_doubling             10 :\t", timeit.timeit('fib_doubling(10)', globals=globals(), number=1))
    print("fib_doubling            100 :\t", timeit.timeit('fib_doubling(100)', globals=globals(), number=1))
    print("fib_doubling          1 000 :\t", timeit.timeit('fib_doubling(1000)', globals=globals(), number=1))
    print("fib_doubling         10 000 :\t", timeit.timeit('fib_doubling(10000)', globals=globals(), number=1))
    print("fib_doubling        100 000 :\t", timeit.timeit('fib_doubling(100000)', globals=globals(), number=1))
    ...
    # print("fib_doubling     20 000 000 :\t", timeit.timeit('fib_doubling(100000000)', globals=globals(), number=1))
    # print("fib_doubling    100 000 000 :\t", timeit.timeit('fib_doubling(100000000)', globals=globals(), number=
