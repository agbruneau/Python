...
fahrenheit_q = np.array(
    [-200, -90, -40,  14, 32, 46, 59, 72, 100],  dtype=float)
kelvin_a = np.array([144.261, 205.372, 233.15, 263.15,
                     273.15,  280.928, 288.15, 295.372, 310.928],  dtype=float)
